...
**NOTE: I developed a [NEW VERSION FOR 2025](https://github.com/boilermaker-ben/Google-Sheets-NFL-Pick-Ems-Survivor-and-Eliminator-Pool/)--it's in a BETA state, so use the one here for a bit more robust solution!**
